...
$header->param(PAGE_TITLE => $s->{'site_name'}." - Musical Director sought");
$header->param(LINKS => [ {HREF=>"#band",TEXT=>"The band"},
							{HREF=>"#music",TEXT=>"The music"},
							{HREF=>"#members",TEXT=>"The members"},
							{HREF=>"#events",TEXT=>"The events"},
							{HREF=>"faq.pl",TEXT=>"FAQ"},
							 ]);
my $content = HTML::Template->new(filename => "$templates/md.tmpl");
